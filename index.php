...
<div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container-fluid">
                    <h4 class="mt-4"><Strong style="color:green">Sisa Stok Barang : <?php echo $difference; ?></Strong></h4>
                    <br>
                    <br>
                    <div class="row">
                    ...
                    <div class="table-container">
                        ...
                        <table id="dataTable" class="table  table-striped table-bordered">
                            ...
                            <?php
                                ...
                                $data = mysqli_query($koneksi,"select * from barang_masuk WHERE id_user = '$userid'");
                                $no = 1;
                                ...
                                ?>    
                                    <tr class="text-center">
                                        ...
                                        <td style="text-align: center;">
                                            <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="hapusbarangmasuk.php?id_barang_masuk=<?php echo $d['id_barang_masuk']; ?>"><button class="btn-danger">hapus</button></a>
                                        </td>
                                    </tr>
                                    <?php
                                }
                            ...
                            <tfoot>
                            <?php                                 
                                $data7 = mysqli_query($koneksi,"select sum(total_barang_masuk) as total from barang_masuk WHERE id_user = '$userid'");
