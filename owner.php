...
<div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="owner.php" >Stock</a>
                    ...
                    <div class="table-container">
                        ...
                        <table id="dataTable" class="table  table-striped table-bordered">
                            ...
                            <?php
                                ...
                                id_user,
                                (
                                    SELECT COALESCE(SUM(total_barang_masuk), 0) 
                                    FROM barang_masuk 
                                    WHERE barang_masuk.id_user = users.id_user
                                ) -
                                (
                                    SELECT COALESCE(SUM(total_barang_keluar), 0) 
                                    FROM barang_keluar 
                                    WHERE barang_keluar.id_user = users.id_user
                                ) AS difference
                                FROM
                                    (SELECT id_user FROM barang_masuk UNION SELECT id_user FROM barang_keluar) AS users;");
                                $no = 1;
                            ...
                            <?php 
                                ...
                                $data7 = mysqli_query($koneksi,"SELECT (SELECT SUM(total_barang_masuk) FROM barang_masuk) - (SELECT SUM(total_barang_keluar) FROM barang_keluar) AS total");
